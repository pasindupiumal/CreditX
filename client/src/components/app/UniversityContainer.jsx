...
import TransferPage from "../university/TransferPage";
...
export default function UniversityContainer() {
    ...
    if (user._active && user._role === userRole.UNIVERSITY) {
            ...
            <div className={classes.root}>
                ...
                >
                    ...
                    <div hidden={!open}>
                        ...
                        <Typography className={classes.profileStatus}>University</Typography>
                    </div>
