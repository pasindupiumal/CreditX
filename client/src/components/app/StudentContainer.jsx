...
import GradingPage from "../student/GradingPage";
import userContext, {userRole} from "../../context/UserContext";
import RequestPage from "../student/RequestPage";
...
export default function StudentContainer() {
    ...
    if (user._active && user._role === userRole.STUDENT) {
            ...
            <div className={classes.root}>
                ...
                >
                    ...
                    <div hidden={!open}>
                        ...
                        <Typography className={classes.profileStatus}>Student</Typography>
                    </div>
